              ...
              <>
                ...
                <Grid item xs={12} md={6}>
                  <TextField
                    ...
                    size="small"
                    label="Created Date"
                    value={courseData.createdAt ? new Date(courseData.createdAt).toLocaleDateString() : ""}
                    disabled
                    InputProps={{ readOnly: true }}
                  />
                </Grid>
            ...
            <>
              ...
              {selectedFiles.length > 0 && (
                <Alert severity="info" sx={{ mt: 2 }}>
                  {selectedFiles.length} file(s) selected. They will be uploaded when you save the course.
                </Alert>
              )}
            </>
          )}
